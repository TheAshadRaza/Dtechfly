...
export default function Contact(){
    ...
    <div className="relative contact-page ">
        ...
        <h1 className="absolute text-lg md:text-5xl tracking-tighter text-bold text-white bottom-16 md:bottom-24 left-1/2  -translate-x-1/2 "> Tell us , We Fit to your Frame . </h1>
   ...
   {/* //contact from 2nd section */}
    <div className="contactForm bg-muve bg-no-reapet bg-center bg-cover ">

    <section className="text-gray-600 body-font relative">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-white">Contact Us</h1>
      <p className="lg:w-2/3 mx-auto leading-relaxed text-white">Dont'worry we promise to take care of your data..</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-red-600 border-0  py-2 px-8 focus:outline-none hover:bg-black rounded-2xl text-lg"  onClick={notify} >Button</button>
